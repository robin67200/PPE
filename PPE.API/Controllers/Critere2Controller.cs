...
namespace Timesheet.API.Controllers
{
    ...
    [ApiController]
    public class Critere2sController : ControllerBase
    {
       private readonly PPEAPIContext _context;
       public Critere2sController (PPEAPIContext context)
       {
           _context = context;
       }
